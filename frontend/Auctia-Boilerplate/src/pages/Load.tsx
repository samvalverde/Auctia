...
export default function Load() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-10 flex flex-col items-center min-h-screen">
      <h2 className="text-3xl font-bold text-gray-900">Carga tu inventario</h2>
      ...
      <div className="mt-10 w-full">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">Tamaño máximo por archivo: 50MB</p>
          </div>
        </div>
        {filesList.length > 0 && (
          <>
